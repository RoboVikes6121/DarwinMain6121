...
public class Climber extends SubsystemBase {
    ...
    public Climber() {
        motor = new TalonFX(Ports.climberMotor, Ports.kCANBus);
    ...
    public Command TannersClimberExtend() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'TannersClimberExtend'");
    }
}