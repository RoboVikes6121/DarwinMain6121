...
public class Launcher extends SubsystemBase {
    ...
    public Launcher() {
        leftMotor = new TalonFX(Ports.leftLauncherMotor, Ports.kCANBus);
        middleMotor = new TalonFX(Ports.centerLauncherMotor, Ports.kCANBus);
        rightMotor = new TalonFX(Ports.rightLauncherMotor, Ports.kCANBus);
