...
public class PrepareShotCommand extends Command {
    ...
    static {
        distanceToShotMap.put(Inches.of(52.0), new Shot(2415, 0.19));
        distanceToShotMap.put(Inches.of(114.4), new Shot(2800, 0.40));
        distanceToShotMap.put(Inches.of(165.5), new Shot(3090, 0.48));
        distanceToShotMap.put(Inches.of(205), new Shot(3600, 0.48));
    }
    ...
    public PrepareShotCommand(Launcher launcher, Hood hood, Supplier<Pose2d> robotPoseSupplier) {
    ...
    public void execute() {
        ...
        launcher.setRPM(shot.shooterRPM);
